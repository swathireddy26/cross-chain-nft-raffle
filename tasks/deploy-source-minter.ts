...
task(`deploy-source-minter`, `Deploys SourceMinter.sol smart contract`)
    ...
    .setAction(async (taskArguments: TaskArguments, hre: HardhatRuntimeEnvironment) => {
        ...
        const raffleContractAddress = taskArguments.raffleContract ? taskArguments.raffleContract : LINK_ADDRESSES[hre.network.name]
        ...
        const sourceMinter: SourceMinter = await sourceMinterFactory.deploy(routerAddress, linkAddress, raffleContractAddress);
